  ...
  return (
    <form className='flex flex-col w-full items-start gap-3' onSubmit={onSubmitHandler}>
      <div>
        ...
        <div className='flex gap-2'>
          ...
          <label htmlFor='image4'>
            ...
            <input type='file' onChange={(e)=>setImage4(e.target.files[0])} id="image4" hidden></input>
          </label>
      ...
      <div className='w-full'>
        ...
        className='w-full max-w-[500px] px-3 py-2' value={name} onChange={(e)=> setName(e.target.value)}></input>
      </div>

      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea type='text' placeholder='Write content here' required 
        className='w-full max-w-[500px] px-3 py-2' value={description} onChange={(e)=> setDescription(e.target.value)}/>
      </div>
